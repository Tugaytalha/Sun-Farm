...
public class CategoryService {
    ...
    public void initializeCategories() {
        if (categoryRepository.count() == 0) {
            ...
            sports_and_outdoors.setTitle("Kablolar");
            ...
            health_and_beauty.setTitle("Konnektör");
